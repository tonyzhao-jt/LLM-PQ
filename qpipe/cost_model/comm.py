...
class CommCostModel:
    def __init__(self, comm_cost_model_folder, single_device=False) -> None:
        self.cost_model = {}
        ...
        self.rank_map = {} # in some case, we need to change the device order, then the rank of the device will change
