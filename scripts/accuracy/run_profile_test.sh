...
CUDA_VISIBLE_DEVICES=0 python3 main.py  bigscience/bloom-560m c4 --wbits 2 --task piqa
CUDA_VISIBLE_DEVICES=0 python3 main.py  bigscience/bloom-560m c4 --wbits 3 --task piqa
CUDA_VISIBLE_DEVICES=0 python3 main.py  bigscience/bloom-560m c4 --wbits 4 --task piqa
CUDA_VISIBLE_DEVICES=0 python3 main.py  bigscience/bloom-560m c4 --wbits 8 --task piqa
CUDA_VISIBLE_DEVICES=0 python3 main.py  bigscience/bloom-560m c4 --wbits 18 --task piqa