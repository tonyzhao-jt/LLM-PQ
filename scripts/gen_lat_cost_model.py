...
predict_lat = lat_cost_model.predict('Tesla_V100-SXM2-32GB', 1, 16, s, 0, 7168, 28672, 4)
groud_lat = lat_cost_model.fetch_lat('Tesla_V100-SXM2-32GB', 1, 16, s, 0, 7168, 28672, 4)
print(predict_lat, groud_lat)
predict_lat = lat_cost_model.predict('Tesla_V100-SXM2-32GB', 1, 16, s, 0, 7168, 28672, '8:tc-li')
groud_lat = lat_cost_model.fetch_lat('Tesla_V100-SXM2-32GB', 1, 16, s, 0, 7168, 28672, '8:tc-li')
print(predict_lat, groud_lat)
