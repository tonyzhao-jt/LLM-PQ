...
llm_pq-algo --model_size ${model_size} \
 ...
 --fname-suffix "group_llm_pqh" 2>&1 | tee "${ABLATION_FOLDER}${model_size}_GROUP_SIZE${GROUP_SIZE}"
...
# llm_pq result: Minimax Lat 127606.2088761086
# llm_pq time:  5.81243896484375
...
llm_pq-algo --model_size ${model_size} \
 ...
 --theta 1  --global_bz 32 --debug --ilp_time_limit 60 --fit \
 --fname-suffix "group_$GROUP_SIZE" 2>&1 | tee "${ABLATION_FOLDER}${model_size}_GROUP_SIZE${GROUP_SIZE}"
# llm_pq result: Minimax Lat 112720.37227891953
# llm_pq time:  104.73534512519836
