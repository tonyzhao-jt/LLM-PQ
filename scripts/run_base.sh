...
python adaptive_bits.py --model_size "30b" --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 4 1 
python qpipe_ilp.py --model_size "30b" --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 4 1 
python qpipe_ilp.py --model_size "30b" --SLO-aware --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 4 1 
python uniform.py --model_size "30b" --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 4 1 
python pipeedge_algo.py  --model_size "30b" --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 4 1 
python pipeedge_algo.py  --model_size "30b" --bit 16 --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 4 1 
# python pipeedge_algo.py  --model_size "30b"  --adaptive --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 2 1 
python convert_and_valid_strat.py --model_size "30b" --device_names Tesla_T4 Tesla_V100-SXM2-32GB --device_numbers 4 1
