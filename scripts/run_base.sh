...
python pipeedge_algo.py  --model_size "30b" --device_names Tesla_V100-SXM2-32GB NVIDIA_A100-SXM4-40GB --device_numbers 4 4
python pipeedge_algo.py  --model_size "30b"  --adaptive --device_names Tesla_V100-SXM2-32GB NVIDIA_A100-SXM4-40GB --device_numbers 4 4 
