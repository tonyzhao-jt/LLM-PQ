...
torchrun --nnodes=1 --nproc_per_node=2 --node_rank=0 --master_port 7000 profile_comm.py
torchrun --nnodes=1 --nproc_per_node=2 --node_rank=0 --master_port 7000 profile_comm.py --nccl