...
def llm_pq_h_internal_main(num_hidden_layers, cost_model_pack, bz_pack, current_D):
    (global_bz, prefill_bz, bz_decode_max) = bz_pack 
    ...
    if plan != NOT_AVAILABLE:
        ...
        model_mem_estimator, comm_cost_model, lat_cost_model = cost_model_pack
        check_memory_budget(res, model_mem_estimator, name='llm_pq_h')
...
def enumerate_best_result(args):
    ...
    for perm in permutations:
        ...
        for prefill_bz in candidate_prefill_bzs:
            ...
            res = llm_pq_h_internal_main(num_hidden_layers, cost_model_pack, bz_pack, current_D)
            ...
            if res['obj'] < best_plan['obj']:
                ...
                check_memory_budget(best_plan, model_mem_estimator, name='llm_pq_h')
