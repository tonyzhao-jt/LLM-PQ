...
# user_abs_file_path="sols_opt_66b_Tesla_T4_4_Tesla_V100-SXM2-32GB_2_hess_scheme"
# # dont change this part
# device_info="Tesla_V100-SXM2-32GB_1"
# folder_abs_path="${ROOT_DIR}/scripts/accuracy/bit_for_gptq_test"
# bash test_plan_acc_cmd.sh --model_name $model_name --model_size $model_size --storage_path $sample_acc_dir \
...
model_size="66b" # must match with the following, else error.
user_abs_file_path="sols_opt_66b_Tesla_V100-SXM2-32GB_2_NVIDIA_A100-SXM4-40GB_2group_1_random"
# dont change this part
device_info="Tesla_V100-SXM2-32GB_1"
folder_abs_path="${ROOT_DIR}/scripts/accuracy/bit_for_gptq_test"
bash test_plan_acc_cmd.sh --model_name $model_name --model_size $model_size --storage_path $sample_acc_dir \
...
# model_size="66b" # must match with the following, else error.
# user_abs_file_path="sols_opt_66b_Tesla_T4_4_Tesla_V100-SXM2-32GB_2_shaq_scheme"
# # dont change this part
# device_info="Tesla_V100-SXM2-32GB_1"
# folder_abs_path="${ROOT_DIR}/scripts/accuracy/bit_for_gptq_test"
# bash test_plan_acc_cmd.sh --model_name $model_name --model_size $model_size --storage_path $sample_acc_dir \
