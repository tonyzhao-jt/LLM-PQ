        ...
        if use_incremental:
            ...
            for i in range(N):
                ...
                if result != NOT_AVAILABLE:
                    ...
                    raise ValueError('sub problem should not be infeasible, try original shaq.')
...
def main(args):
    ...
    use_incremental = args.shaq_ef_incremental
...
#     from .entry import convert_to_shaq_result2partitions
#     ilp_env()
#     args = common_argparser()
#     best_plan = main(args)
#     # model size
#     sols = {
#         'shaq': convert_to_shaq_result2partitions(best_plan)
#     }
