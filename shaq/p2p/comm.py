...
from shaq._globals import __PIPELINE__MODEL__PARALLEL__GROUP__
...
def _send_tensor(tensor, dst, tag_base, fn_send=dist.send):
    __DEVICE__INDEX__ = shaq._globals.__DEVICE__INDEX__
    __PIPELINE__MODEL__PARALLEL__GROUP__ = shaq._globals.__PIPELINE__MODEL__PARALLEL__GROUP__
