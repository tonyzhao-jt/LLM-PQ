...
import shaq
from shaq.utils import to_device
from shaq.rpc import get_neighbor_ranks
...
class DistRpcPipelineStage:
    ...
    def __init__(self, module_cls, module_args: Optional[tuple]=None,
        ...
        self.stage_device = torch.device("cuda", shaq._globals.__DEVICE__INDEX__)
        self.stage_id = stage_id
        self.tp_index = shaq._globals.__TP__LOCAL__RANK__
        self.use_nccl = shaq._globals.__USE__NCCL__ 
