...
# p2p
torchrun --nnodes=2 --nproc_per_node=4 --master_addr net-g13 --master_port 6666 --node_rank=0 main_p2p.py
torchrun --nnodes=2 --nproc_per_node=4 --master_addr net-g13 --master_port 6666 --node_rank=1 main_p2p.py
...
# p2p test dist
torchrun --nnodes=2 --node_rank=0 --nproc_per_node=2 --master_addr net-g13 --master_port 6666 main_p2p.py --model_name opt --model_size "350m"
torchrun --nnodes=2 --node_rank=1 --nproc_per_node=2 --master_addr net-g13 --master_port 6666 main_p2p.py --model_name opt --model_size "350m"
